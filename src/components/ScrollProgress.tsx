    ...
    return (
        <React.Fragment>
            ...
            <div className="fixed left-0 top-0 bottom-0 w-1 md:w-1.5 z-[100] bg-slate-200 dark:bg-white/5 hidden md:block">
                {/* Neon Progress Bar */}
                <motion.div
                    className="absolute top-0 left-0 w-full bg-violet-600 dark:bg-violet-500 origin-top shadow-[0_0_15px_rgba(139,92,246,0.5)] dark:shadow-[0_0_20px_rgba(167,139,250,0.8)]"
